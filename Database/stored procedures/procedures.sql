...
DO $$
BEGIN
    SELECT id INTO v_rol_cliente FROM rol WHERE nombre = 'cliente';
    SELECT id INTO v_tipo_nacional FROM tipoIdentificacion WHERE nombre = 'Nacional';
    
    -- Hash de la contraseña "password123" (deberías usar bcrypt en la API real)
    -- Este es un hash bcrypt de ejemplo
    v_password_hash := '$2b$10$rKvF3YqMYmCQvL0Vz2QhLuqK.8xdVLxEZlH0pBPJE6QKzW.Xm9bXi';
